...
btnAddon.addEventListener("click", (event)=>{
    ...
    if (addOnSocial.value === "true") total += 50;
    total += factura.addonAdicionalCredito(true, addOnVideo.value);
    div2.innerHTML = total;
});

},{"../src/adapter/in/facturaController":"eDm99"}],"eDm99":[function(require,module,exports) {
class FacturaController {
    cantMegasAddons(plan, addon) {
        let megas = 0;
        if (plan === "Plan S a medida" || plan === "Plan M a medida" || plan === "Plan L a medida") switch(addon){
            case "DATOS S":
                megas = 1200;
                break;
            case "DATOS M":
...
},{}]},["gkoGO","jZ78i"], "jZ78i", "parcelRequire6de3")
